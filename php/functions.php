    ...
    */
    ...
    function print_metadata () {
        ...
        <html lang='eng' dir='ltr'>
            <head>
                <meta charset='{$C('WEBSITE_CHARSET')}'  />
    ...
    function print_header($title, $randstr, $logged_in_as) {
        $C = 'constant'; //create a variable that references the constant function

        //using the parameters, finish the header of the document with a personalised title, and start the body section with the logo
        echo <<<_ECHO
                <title>$title</title>
            </head>
            </body>
    ...
    function display_personalised_button_link_list($logged_in, $privilege, $randstr) {
        $C = 'constant'; //create a variable that references the constant function
    ...
    function display_header($title, $randstr, $logged_in_as, $logged_in, $privilege) {
        print_metadata();
